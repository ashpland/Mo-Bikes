...
enum Styles {
    ...
    static let markerColor = (normal: #colorLiteral(red: 0.5791940689, green: 0.1280144453, blue: 0.5726861358, alpha: 1),
                              low: #colorLiteral(red: 0.7806914647, green: 0.5464840253, blue: 0.7773131953, alpha: 1))
    static let bikeRouteColor = #colorLiteral(red: 0.3018391927, green: 0.6276475694, blue: 1, alpha: 1)
}
